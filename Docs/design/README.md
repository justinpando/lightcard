...
| 2. Playable match | Field scene wired to the engine; play vs. a Tier-1 heuristic AI | AI half done on this branch (`Core/Agents`: personalities, simulate-and-score agent, headless MatchRunner); the Field view layer remains |
